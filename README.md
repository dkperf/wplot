...
There are a few .dpt command file examples in the examples folder.  Just download the examples folder contents and then type "wplot xxx.dpt" to see that particular plot example.
